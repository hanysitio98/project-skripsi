...
const EditFreelancer = () => {
  ...
  useEffect(() => {
    ...
    if (id) {
      FreelancerService.getFreelancerById(id).then((response) => {
  ...
  const updateFreelancer = async (e) => {
    e.preventDefault();
    try {
      const response = await FreelancerService.updateFreelancer(id, freelancers);
                ...
                <Card style={{ width: '14rem' }} >
                  ...
                  <Card.Body className='p-3'>
                    <div className="d-flex justify-content-center">
                      <img src={`${APP_BASE_URL}/api/images/${freelancers.freelancerImage}`} alt="" width="80px" height="76px" />
                    </div>
                  </Card.Body>
                </Card>
              </Col>
              ...
              <Col className="col-12 col-lg-6">
                <Form>
                  <Form.Group className="pb-3">
                    <Form.Label className="font-weight-bold">NAMA FREELANCER</Form.Label>
                  ...
                  <Form.Group className="pb-3">
                    <Form.Label className="font-weight-bold">ID CARD</Form.Label>
                  ...
                  <Col className="col-12 col-lg-4 p-0">
                    <button className="btn btn btn-primary btn-block" type="submit" onClick={(e) => updateFreelancer(e)}
                    >
                      Submit
                    </button>
                  </Col>
